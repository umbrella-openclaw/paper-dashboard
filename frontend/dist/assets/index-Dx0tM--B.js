 ...
 */function c(t){return z({...t,state:!0,attribute:!1})}const Mt="/api";async function A(t,e,a){const r={method:t,headers:{}};a instanceof FormData?r.body=a:a&&(r.headers={"Content-Type":"application/json"},r.body=JSON.stringify(a));const s=await fetch(`${Mt}${e}`,r);if(!s.ok){const i=await s.json().catch(()=>({error:"Unknown error"}));throw new Error(i.error||`HTTP ${s.status}`)}return s.json()}const j={uploadPaper:t=>A("POST","/papers",t),listPapers:t=>{const e=new URLSearchParams;t!=null&&t.page&&e.set("page",String(t.page)),t!=null&&t.limit&&e.set("limit",String(t.limit)),t!=null&&t.search&&e.set("search",t.search),t!=null&&t.folder_id&&e.set("folder_id",String(t.folder_id));const a=e.toString();return A("GET",`/papers${a?`?${a}`:""}`)},getPaper:t=>A("GET",`/papers/${t}`),updatePaper:(t,e)=>A("PUT",`/papers/${t}`,e),deletePaper:t=>A("DELETE",`/papers/${t}`),listFolders:()=>A("GET","/folders"),createFolder:(t,e)=>A("POST","/folders",{name:t,parent_id:e}),deleteFolder:t=>A("DELETE",`/folders/${t}`),listTags:()=>A("GET","/tags"),createTag:(t,e)=>A("POST","/tags",{name:t,color:e||"#10b981"}),deleteTag:t=>A("DELETE",`/tags/${t}`),getStats:()=>A("GET","/stats")};var jt=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,vt=(t,e,a,r)=>{for(var s=r>1?void 0:r?Nt(e,a):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(s=(r?o(e,a,s):o(s))||s);return r&&s&&jt(e,a,s),s};let be=class extends f{constructor(){super(...arguments),this.searchValue=""}onSearch(t){const e=t.target;this.searchValue=e.value,this.dispatchEvent(new CustomEvent("search",{detail:this.searchValue}))}render(){return n`
  ...
  `;Fe([z({type:Object})],oe.prototype,"paper",2);Fe([c()],oe.prototype,"showConfirm",2);oe=Fe([w("paper-card")],oe);var Bt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,ut=(t,e,a,r)=>{for(var s=r>1?void 0:r?Kt(e,a):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(s=(r?o(e,a,s):o(s))||s);return r&&s&&Bt(e,a,s),s};let me=class extends f{constructor(){super(...arguments),this.papers=[]}render(){return n`
      <div class="grid">
        ${this.papers.map(t=>n`
  ...
  `;C([z({type:Array})],S.prototype,"folders",2);C([c()],S.prototype,"file",2);C([c()],S.prototype,"paperTitle",2);C([c()],S.prototype,"authors",2);C([c()],S.prototype,"abstract",2);C([c()],S.prototype,"journal",2);C([c()],S.prototype,"year",2);C([c()],S.prototype,"doi",2);C([c()],S.prototype,"folderId",2);C([c()],S.prototype,"loading",2);C([c()],S.prototype,"error",2);S=C([w("paper-uploader")],S);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
        ...
        <article class="panel">
          ...
          ${this.paperMetadata?n`
            <div class="paper-preview">
              ...
              `:""}
              ${(u=this.paperMetadata.analysisRecords)!=null&&u.length?n`
                <div class="preview-section">
        ...
        <article class="panel">
          ...
          `:s?n`
            <div class="empty" style="border-color: #fee2e2; color: #991b1b;">
              处理出错：${((b=this.taskStatus)==null?void 0:b.error)||"未知错误"}
            </div>
          `:n`
