 ...
 */function p(t){return y({...t,state:!0,attribute:!1})}const st="/api";async function w(t,e,r){const s={method:t,headers:{}};r instanceof FormData?s.body=r:r&&(s.headers={"Content-Type":"application/json"},s.body=JSON.stringify(r));const a=await fetch(`${st}${e}`,s);if(!a.ok){const o=await a.json().catch(()=>({error:"Unknown error"}));throw new Error(o.error||`HTTP ${a.status}`)}return a.json()}const z={uploadPaper:t=>w("POST","/papers",t),listPapers:t=>{const e=new URLSearchParams;t!=null&&t.page&&e.set("page",String(t.page)),t!=null&&t.limit&&e.set("limit",String(t.limit)),t!=null&&t.search&&e.set("search",t.search),t!=null&&t.folder_id&&e.set("folder_id",String(t.folder_id));const r=e.toString();return w("GET",`/papers${r?`?${r}`:""}`)},getPaper:t=>w("GET",`/papers/${t}`),updatePaper:(t,e)=>w("PUT",`/papers/${t}`,e),deletePaper:t=>w("DELETE",`/papers/${t}`),listFolders:()=>w("GET","/folders"),createFolder:(t,e)=>w("POST","/folders",{name:t,parent_id:e}),deleteFolder:t=>w("DELETE",`/folders/${t}`),listTags:()=>w("GET","/tags"),createTag:(t,e)=>w("POST","/tags",{name:t,color:e||"#10b981"}),deleteTag:t=>w("DELETE",`/tags/${t}`),getStats:()=>w("GET","/stats")};var ot=Object.defineProperty,it=Object.getOwnPropertyDescriptor,Re=(t,e,r,s)=>{for(var a=s>1?void 0:s?it(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(a=(s?i(e,r,a):i(a))||a);return s&&a&&ot(e,r,a),a};let ae=class extends ${constructor(){super(...arguments),this.searchValue=""}onSearch(t){const e=t.target;this.searchValue=e.value,this.dispatchEvent(new CustomEvent("search",{detail:this.searchValue}))}render(){return n`
  ...
  `;Re([p()],ae.prototype,"searchValue",2);ae=Re([E("paper-header")],ae);var nt=Object.defineProperty,ct=Object.getOwnPropertyDescriptor,ie=(t,e,r,s)=>{for(var a=s>1?void 0:s?ct(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(a=(s?i(e,r,a):i(a))||a);return s&&a&&nt(e,r,a),a};let H=class extends ${constructor(){super(...arguments),this.folders=[],this.tags=[],this.selectedFolderId=null}selectFolder(t){this.dispatchEvent(new CustomEvent("folder-select",{detail:t}))}createPaper(){this.dispatchEvent(new CustomEvent("create-paper"))}render(){return n`
      <div class="sidebar">
  ...
  `;be([y({type:Object})],Y.prototype,"paper",2);be([p()],Y.prototype,"showConfirm",2);Y=be([E("paper-card")],Y);var pt=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,Ue=(t,e,r,s)=>{for(var a=s>1?void 0:s?ht(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(a=(s?i(e,r,a):i(a))||a);return s&&a&&pt(e,r,a),a};let se=class extends ${constructor(){super(...arguments),this.papers=[]}render(){return n`
      <div class="grid">
        ${this.papers.map(t=>n`
 ...
 */class he extends bt{constructor(e){if(super(e),this.it=g,e.type!==vt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===g||e==null)return this._t=void 0,this.it=e;if(e===N)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const r=[e];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}he.directiveName="unsafeHTML",he.resultType=1;const mt=ft(he);var yt=Object.defineProperty,xt=Object.getOwnPropertyDescriptor,ne=(t,e,r,s)=>{for(var a=s>1?void 0:s?xt(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(a=(s?i(e,r,a):i(a))||a);return s&&a&&yt(e,r,a),a};let B=class extends ${constructor(){super(...arguments),this.label="",this.value=0,this.icon="file"}getIcon(){const t={"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>',calendar:'<rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>',folder:'<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>',tag:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>'};return t[this.icon]||t["file-text"]}render(){return n`
  ...
  `;J([y({type:String})],M.prototype,"currentStage",2);J([y({type:Array})],M.prototype,"completedStages",2);J([y({type:Boolean})],M.prototype,"canAdvance",2);J([y({type:Boolean})],M.prototype,"canRollback",2);M=J([E("stage-navigator")],M);var kt=Object.defineProperty,_t=Object.getOwnPropertyDescriptor,x=(t,e,r,s)=>{for(var a=s>1?void 0:s?_t(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(a=(s?i(e,r,a):i(a))||a);return s&&a&&kt(e,r,a),a};const S="http://192.168.1.161:8080",St="3a3ce9520026e5ca4b4196f964fda10fb71fa224f0c2925fd031373298844f8a";function At(){return{"X-Api-Key":St,"Content-Type":"application/json"}}function O(t,e={}){return fetch(t,{...e,headers:{...At(),...e.headers||{}}})}let f=class extends ${constructor(){super(...arguments),this.taskId=null,this.taskStatus=null,this.topics=[],this.selectedTopicId=null,this.selectedTopic={title:"",researchObjective:"",expectedContribution:"",selectedCandidateId:null},this.feedbackHistory=[],this.currentFeedback="",this.dragover=!1,this.debugMode=!1,this.debugLogs=[],this.apiConnected=!1,this.apiChecking=!0,this.errorMessage="",this.pollInterval=null}connectedCallback(){super.connectedCallback(),this.checkApiConnection(),this.loadExistingTask()}saveTaskId(t){t?localStorage.setItem("paper-dashboard-task-id",t):localStorage.removeItem("paper-dashboard-task-id")}loadTaskId(){return localStorage.getItem("paper-dashboard-task-id")}async loadExistingTask(){const t=this.loadTaskId();if(t){console.log("[ConfigStage] Found saved task:",t),this.debug("log","loadExistingTask_found",{taskId:t});try{const e=await O(`${S}/api/tasks/${t}/status`);if(e.ok){const r=await e.json();if(r){this.taskId=t,this.taskStatus=r,this.debug("log","loadExistingTask_success",{status:r});return}}}catch(e){console.warn("[ConfigStage] Failed to load existing task:",e)}this.saveTaskId(null)}this.debug("log","loadExistingTask_noTask")}disconnectedCallback(){super.disconnectedCallback(),this.pollInterval&&clearInterval(this.pollInterval)}async checkApiConnection(){this.apiChecking=!0;try{(await fetch(`${S}/api/health`)).ok?(this.apiConnected=!0,this.debug("log","apiConnected")):(this.apiConnected=!1,this.debug("warn","apiDisconnected"))}catch{this.apiConnected=!1,this.debug("warn","apiDisconnected")}this.apiChecking=!1}async createTask(){if(console.log("[ConfigStage] createTask called, apiConnected:",this.apiConnected),this.debug("log","checkApiConnection_start"),this.debug("log","createTask_start",{apiConnected:this.apiConnected}),!this.apiConnected){this.errorMessage="后端服务未连接，请刷新页面重试";return}try{const t=await O(`${S}/api/tasks`,{method:"POST"});if(t.ok){const e=await t.json();this.taskId=e.task_id,this.saveTaskId(e.task_id),this.taskStatus=e.status,this.startPolling(),this.notifyReadyState()}}catch(t){this.errorMessage=`创建任务失败: ${t.message}`}}startPolling(){this.pollInterval&&clearInterval(this.pollInterval),this.pollInterval=window.setInterval(()=>{this.checkStatus()},2e3)}async checkStatus(){var t;if(this.taskId)try{const e=await O(`${S}/api/tasks/${this.taskId}/status`);e.ok&&(this.taskStatus=await e.json(),((t=this.taskStatus)==null?void 0:t.stage_status)==="waiting_confirm"&&await this.loadTopics(),this.notifyReadyState())}catch(e){console.error("Status check failed:",e)}}async loadTopics(){if(this.taskId)try{const t=await O(`${S}/api/tasks/${this.taskId}/topics`);if(t.ok){const e=await t.json();this.topics=e.topics||[]}}catch(t){console.error("Failed to load topics:",t)}}debug(t,e,r){const s={timestamp:Date.now(),level:t,action:e,data:r};console[t]("[ConfigStage]",e,r),this.debugMode&&(this.debugLogs=[...this.debugLogs.slice(-99),s],this.requestUpdate()),this.dispatchEvent(new CustomEvent("debug-log",{detail:s,bubbles:!0,composed:!0}))}toggleDebug(){this.debugMode=!this.debugMode,this.debugLogs=[]}clearDebugLogs(){this.debugLogs=[]}notifyReadyState(){var e;const t=((e=this.taskStatus)==null?void 0:e.stage_status)==="waiting_confirm"&&this.selectedTopic.title.trim().length>0;this.dispatchEvent(new CustomEvent("config-ready-change",{detail:!!t}))}onReferenceFileInput(t){const e=t.target;!e.files||e.files.length===0||(this.uploadPapers(Array.from(e.files)),e.value="")}onDrop(t){var r;t.preventDefault(),this.dragover=!1;const e=(r=t.dataTransfer)==null?void 0:r.files;!e||e.length===0||this.uploadPapers(Array.from(e).filter(s=>s.name.endsWith(".pdf")))}onDragOver(t){t.preventDefault(),this.dragover=!0}onDragLeave(){this.dragover=!1}async uploadPapers(t){if(console.log("[ConfigStage] uploadPapers called with",t.length,"files"),t.length!==0){if(!this.taskId){console.log("[ConfigStage] No taskId, creating task first..."),this.createTask().then(()=>{console.log("[ConfigStage] Task created, taskId:",this.taskId),this.taskId&&this.doUpload(t)});return}this.doUpload(t)}}async doUpload(t){console.log("[ConfigStage] doUpload called with",t.length,"files, taskId:",this.taskId);for(const e of t)try{const r=new FormData;if(r.append("paper",e),!(await fetch(`${S}/api/tasks/${this.taskId}/papers`,{method:"POST",body:r})).ok)throw new Error("Upload failed")}catch(r){this.errorMessage=`上传失败: ${r.message}`}await this.triggerOpenClawSession()}async triggerOpenClawSession(){if(this.taskId){this.errorMessage="";try{if(this.taskStatus&&(this.taskStatus={...this.taskStatus,stage_status:"processing",messages:[...this.taskStatus.messages,{timestamp:new Date().toISOString(),from:"system",content:"正在启动 OpenClaw Session 进行论文分析..."}]}),!(await O(`${S}/api/tasks/${this.taskId}/trigger`,{method:"POST"})).ok)throw new Error("Trigger failed");this.startPolling()}catch(t){this.errorMessage=`触发失败: ${t.message}`}}}selectTopic(t){this.selectedTopicId=t.id,this.selectedTopic={title:t.title,researchObjective:`针对 "${t.title}" 的核心问题，建立理论模型并进行数值验证。`,expectedContribution:"提出一种可行的研究方案，产出具有创新性的学术成果。",selectedCandidateId:t.id},this.notifyReadyState()}async submitFeedback(){!this.currentFeedback.trim()||!this.selectedTopicId||(this.feedbackHistory=[...this.feedbackHistory,{feedback:this.currentFeedback.trim(),timestamp:new Date}],this.taskId&&await O(`${S}/api/tasks/${this.taskId}/messages`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:"feedback",data:{feedback:this.currentFeedback,topicId:this.selectedTopicId}})}),this.currentFeedback="",this.errorMessage="反馈已提交，OpenClaw 正在处理...")}regenerateTopics(){this.errorMessage="正在重新生成选题..."}updateTopicField(t,e){this.selectedTopic={...this.selectedTopic,[t]:e},this.notifyReadyState()}async confirmTopic(){if(!this.selectedTopic.title.trim()){this.errorMessage="请先选择一个选题或输入论文标题";return}this.taskId&&await O(`${S}/api/tasks/${this.taskId}/topics`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({topic:this.selectedTopic})}),this.notifyReadyState(),this.dispatchEvent(new CustomEvent("topic-confirmed",{detail:{topic:this.selectedTopic,taskId:this.taskId}}))}get progressPercent(){var r;if(!((r=this.taskStatus)!=null&&r.progress))return 0;const{papers_processed:t,papers_total:e}=this.taskStatus.progress;return e>0?Math.round(t/e*100):0}get uploadedPapersCount(){var t,e;return((e=(t=this.taskStatus)==null?void 0:t.progress)==null?void 0:e.papers_total)||0}render(){var o,i,d,l;const t=!!this.taskId,e=this.topics.length>0,r=((o=this.taskStatus)==null?void 0:o.stage_status)==="processing",s=((i=this.taskStatus)==null?void 0:i.stage_status)==="waiting_confirm",a=((d=this.taskStatus)==null?void 0:d.stage_status)==="error";return n`
