 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zt={attribute:!0,type:String,converter:ge,reflect:!1,hasChanged:Fe},Rt=(t=zt,e,a)=>{const{kind:r,metadata:s}=a;let i=globalThis.litPropertyMetadata.get(s);if(i===void 0&&globalThis.litPropertyMetadata.set(s,i=new Map),r==="setter"&&((t=Object.create(t)).wrapped=!0),i.set(a.name,t),r==="accessor"){const{name:o}=a;return{set(l){const p=e.get.call(this);e.set.call(this,l),this.requestUpdate(o,p,t,!0,l)},init(l){return l!==void 0&&this.C(o,void 0,t,l),l}}}if(r==="setter"){const{name:o}=a;return function(l){const p=this[o];e.call(this,l),this.requestUpdate(o,p,t,!0,l)}}throw Error("Unsupported decorator location: "+r)};function k(t){return(e,a)=>typeof a=="object"?Rt(t,e,a):((r,s,i)=>{const o=s.hasOwnProperty(i);return s.constructor.createProperty(i,r),o?Object.getOwnPropertyDescriptor(s,i):void 0})(t,e,a)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function c(t){return k({...t,state:!0,attribute:!1})}const Ot="/api";async function I(t,e,a){const r={method:t,headers:{}};a instanceof FormData?r.body=a:a&&(r.headers={"Content-Type":"application/json"},r.body=JSON.stringify(a));const s=await fetch(`${Ot}${e}`,r);if(!s.ok){const i=await s.json().catch(()=>({error:"Unknown error"}));throw new Error(i.error||`HTTP ${s.status}`)}return s.json()}const M={uploadPaper:t=>I("POST","/papers",t),listPapers:t=>{const e=new URLSearchParams;t!=null&&t.page&&e.set("page",String(t.page)),t!=null&&t.limit&&e.set("limit",String(t.limit)),t!=null&&t.search&&e.set("search",t.search),t!=null&&t.folder_id&&e.set("folder_id",String(t.folder_id));const a=e.toString();return I("GET",`/papers${a?`?${a}`:""}`)},getPaper:t=>I("GET",`/papers/${t}`),updatePaper:(t,e)=>I("PUT",`/papers/${t}`,e),deletePaper:t=>I("DELETE",`/papers/${t}`),listFolders:()=>I("GET","/folders"),createFolder:(t,e)=>I("POST","/folders",{name:t,parent_id:e}),deleteFolder:t=>I("DELETE",`/folders/${t}`),listTags:()=>I("GET","/tags"),createTag:(t,e)=>I("POST","/tags",{name:t,color:e||"#10b981"}),deleteTag:t=>I("DELETE",`/tags/${t}`),getStats:()=>I("GET","/stats")};var Dt=Object.defineProperty,Mt=Object.getOwnPropertyDescriptor,dt=(t,e,a,r)=>{for(var s=r>1?void 0:r?Mt(e,a):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(s=(r?o(e,a,s):o(s))||s);return r&&s&&Dt(e,a,s),s};let be=class extends g{constructor(){super(...arguments),this.searchValue=""}onSearch(t){const e=t.target;this.searchValue=e.value,this.dispatchEvent(new CustomEvent("search",{detail:this.searchValue}))}render(){return n`
      <div class="header">
        <div class="logo">
 ...
 */class Oe extends Jt{constructor(e){if(super(e),this.it=v,e.type!==Wt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===v||e==null)return this._t=void 0,this.it=e;if(e===L)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const a=[e];return a.raw=a,this._t={_$litType$:this.constructor.resultType,strings:a,values:[]}}}Oe.directiveName="unsafeHTML",Oe.resultType=1;const Vt=Kt(Oe);var Gt=Object.defineProperty,Qt=Object.getOwnPropertyDescriptor,$e=(t,e,a,r)=>{for(var s=r>1?void 0:r?Qt(e,a):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(s=(r?o(e,a,s):o(s))||s);return r&&s&&Gt(e,a,s),s};let X=class extends g{constructor(){super(...arguments),this.label="",this.value=0,this.icon="file"}getIcon(){const t={"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>',calendar:'<rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>',folder:'<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>',tag:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>'};return t[this.icon]||t["file-text"]}render(){return n`
  ...
  `;ne([k({type:String})],U.prototype,"currentStage",2);ne([k({type:Array})],U.prototype,"completedStages",2);ne([k({type:Boolean})],U.prototype,"canAdvance",2);ne([k({type:Boolean})],U.prototype,"canRollback",2);U=ne([y("stage-navigator")],U);var Zt=Object.defineProperty,ea=Object.getOwnPropertyDescriptor,S=(t,e,a,r)=>{for(var s=r>1?void 0:r?ea(e,a):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(s=(r?o(e,a,s):o(s))||s);return r&&s&&Zt(e,a,s),s};const P="http://192.168.1.161:8080",ut="3a3ce9520026e5ca4b4196f964fda10fb71fa224f0c2925fd031373298844f8a";function ta(){return{"X-Api-Key":ut,"Content-Type":"application/json"}}function T(t,e={}){return fetch(t,{...e,headers:{...ta(),...e.headers||{}}})}let b=class extends g{constructor(){super(...arguments),this.taskId=null,this.taskStatus=null,this.topics=[],this.selectedTopicId=null,this.selectedTopic={title:"",researchObjective:"",expectedContribution:"",selectedCandidateId:null},this.feedbackHistory=[],this.currentFeedback="",this.dragover=!1,this.debugMode=!1,this.debugLogs=[],this.apiConnected=!1,this.apiChecking=!0,this.errorMessage="",this.pollInterval=null}connectedCallback(){super.connectedCallback(),this.checkApiConnection(),setTimeout(()=>this.loadExistingTask(),100)}saveTaskId(t){t?localStorage.setItem("paper-dashboard-workflow-task-id",t):localStorage.removeItem("paper-dashboard-workflow-task-id")}loadTaskId(){return localStorage.getItem("paper-dashboard-workflow-task-id")||localStorage.getItem("paper-dashboard-task-id")}async loadExistingTask(){let t=0;for(;!this.apiConnected&&t<50;)await new Promise(a=>setTimeout(a,100)),t++;if(!this.apiConnected){this.debug("warn","loadExistingTask_apiNotConnected");return}this.debug("log","loadExistingTask_start");const e=this.loadTaskId();try{const a=await T(`${P}/api/tasks`);if(a.ok){const s=(await a.json()).tasks||[];this.debug("log","loadExistingTask_foundTasks",{count:s.length});let i=null;if(i=s.find(o=>o.stage_status==="waiting_confirm"&&o.papers_total>0),i||(i=s.find(o=>o.stage_status==="processing"&&o.papers_total>0)),!i&&e&&(i=s.find(o=>o.task_id===e&&o.papers_total>0)),i||(i=s.find(o=>o.papers_total>0)),!i&&e&&(i=s.find(o=>o.task_id===e)),!i&&s.length>0&&(i=s.length>0?s[0]:null),i){this.debug("log","loadExistingTask_loading",{taskId:i.task_id,papers:i.papers_total,status:i.stage_status});const o=await T(`${P}/api/tasks/${i.task_id}/status`);if(o.ok){const l=await o.json();this.taskId=i.task_id,this.taskStatus=l,this.saveTaskId(i.task_id),this.debug("log","loadExistingTask_success",l),this.dispatchEvent(new CustomEvent("task-loaded",{detail:{taskId:i.task_id,status:l},bubbles:!0,composed:!0}));return}}}}catch(a){this.debug("error","loadExistingTask_error",{error:String(a)})}this.debug("log","loadExistingTask_noValidTask"),this.saveTaskId(null),this.taskId=null,this.taskStatus=null}disconnectedCallback(){super.disconnectedCallback(),this.pollInterval&&clearInterval(this.pollInterval)}async checkApiConnection(){this.apiChecking=!0;try{(await fetch(`${P}/api/health`)).ok?(this.apiConnected=!0,this.debug("log","apiConnected")):(this.apiConnected=!1,this.debug("warn","apiDisconnected"))}catch{this.apiConnected=!1,this.debug("warn","apiDisconnected")}this.apiChecking=!1}async createTask(){if(console.log("[ConfigStage] createTask called, apiConnected:",this.apiConnected),this.debug("log","checkApiConnection_start"),this.debug("log","createTask_start",{apiConnected:this.apiConnected}),!this.apiConnected){this.errorMessage="后端服务未连接，请刷新页面重试";return}try{const t=await T(`${P}/api/tasks`,{method:"POST"});if(t.ok){const e=await t.json();this.taskId=e.task_id,this.saveTaskId(e.task_id),this.taskStatus=e.status,this.startPolling(),this.notifyReadyState()}}catch(t){throw this.errorMessage=`创建任务失败: ${t.message}`,t}}startPolling(){this.pollInterval&&clearInterval(this.pollInterval),this.pollInterval=window.setInterval(()=>{this.checkStatus()},2e3)}async checkStatus(){var t;if(this.taskId)try{const e=await T(`${P}/api/tasks/${this.taskId}/status`);e.ok&&(this.taskStatus=await e.json(),((t=this.taskStatus)==null?void 0:t.stage_status)==="waiting_confirm"&&await this.loadTopics(),this.notifyReadyState())}catch(e){console.error("Status check failed:",e)}}async loadTopics(){if(this.taskId)try{const t=await T(`${P}/api/tasks/${this.taskId}/topics`);if(t.ok){const e=await t.json();Array.isArray(e.topics)?this.topics=e.topics:e.topics&&typeof e.topics=="object"?this.topics=[e.topics]:this.topics=[]}}catch(t){console.error("Failed to load topics:",t)}}debug(t,e,a){const r={timestamp:Date.now(),level:t,action:e,data:a};console[t]("[ConfigStage]",e,a),this.debugMode&&(this.debugLogs=[...this.debugLogs.slice(-99),r],this.requestUpdate()),this.dispatchEvent(new CustomEvent("debug-log",{detail:r,bubbles:!0,composed:!0}))}toggleDebug(){this.debugMode=!this.debugMode,this.debugLogs=[]}clearDebugLogs(){this.debugLogs=[]}notifyReadyState(){var e;const t=((e=this.taskStatus)==null?void 0:e.stage_status)==="waiting_confirm"&&this.selectedTopic.title.trim().length>0;this.dispatchEvent(new CustomEvent("config-ready-change",{detail:!!t}))}onReferenceFileInput(t){const e=t.target;!e.files||e.files.length===0||(this.uploadPapers(Array.from(e.files)),e.value="")}onDrop(t){var a;t.preventDefault(),this.dragover=!1;const e=(a=t.dataTransfer)==null?void 0:a.files;!e||e.length===0||this.uploadPapers(Array.from(e).filter(r=>r.name.endsWith(".pdf")))}onDragOver(t){t.preventDefault(),this.dragover=!0}onDragLeave(){this.dragover=!1}async uploadPapers(t){if(console.log("[ConfigStage] uploadPapers called with",t.length,"files"),t.length!==0){if(!this.taskId){console.log("[ConfigStage] No taskId, creating task first...");try{await this.createTask(),console.log("[ConfigStage] Task created, taskId:",this.taskId),this.taskId&&await this.doUpload(t)}catch(e){console.error("[ConfigStage] createTask failed:",e)}return}this.doUpload(t)}}async doUpload(t){console.log("[ConfigStage] doUpload called with",t.length,"files, taskId:",this.taskId);for(const e of t)try{const a=new FormData;if(a.append("paper",e),!(await fetch(`${P}/api/tasks/${this.taskId}/papers`,{headers:{"X-Api-Key":ut},method:"POST",body:a})).ok)throw new Error("Upload failed")}catch(a){this.errorMessage=`上传失败: ${a.message}`}await this.triggerOpenClawSession()}async triggerOpenClawSession(){if(this.taskId){this.errorMessage="";try{if(this.taskStatus&&(this.taskStatus={...this.taskStatus,stage_status:"processing",messages:[...this.taskStatus.messages,{timestamp:new Date().toISOString(),from:"system",content:"正在启动 OpenClaw Session 进行论文分析..."}]}),!(await T(`${P}/api/tasks/${this.taskId}/trigger`,{method:"POST"})).ok)throw new Error("Trigger failed");this.startPolling()}catch(t){this.errorMessage=`触发失败: ${t.message}`}}}selectTopic(t){this.selectedTopicId=t.id??null,this.selectedTopic={title:t.title,researchObjective:`针对 "${t.title}" 的核心问题，建立理论模型并进行数值验证。`,expectedContribution:"提出一种可行的研究方案，产出具有创新性的学术成果。",selectedCandidateId:t.id??null},this.notifyReadyState()}async submitFeedback(){!this.currentFeedback.trim()||!this.selectedTopicId||(this.feedbackHistory=[...this.feedbackHistory,{feedback:this.currentFeedback.trim(),timestamp:new Date}],this.taskId&&await T(`${P}/api/tasks/${this.taskId}/messages`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:"feedback",data:{feedback:this.currentFeedback,topicId:this.selectedTopicId}})}),this.currentFeedback="",this.errorMessage="反馈已提交，OpenClaw 正在处理...")}regenerateTopics(){this.errorMessage="正在重新生成选题..."}updateTopicField(t,e){this.selectedTopic={...this.selectedTopic,[t]:e},this.notifyReadyState()}async confirmTopic(){if(!this.selectedTopic.title.trim()){this.errorMessage="请先选择一个选题或输入论文标题";return}this.taskId&&await T(`${P}/api/tasks/${this.taskId}/topics`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({topic:this.selectedTopic})}),this.notifyReadyState(),this.dispatchEvent(new CustomEvent("topic-confirmed",{detail:{topic:this.selectedTopic,taskId:this.taskId}}))}get progressPercent(){var a;if(!((a=this.taskStatus)!=null&&a.progress))return 0;const{papers_processed:t,papers_total:e}=this.taskStatus.progress;return e>0?Math.round(t/e*100):0}get uploadedPapersCount(){var t,e;return((e=(t=this.taskStatus)==null?void 0:t.progress)==null?void 0:e.papers_total)||0}render(){var i,o,l,p;const t=!!this.taskId,e=this.topics.length>0,a=((i=this.taskStatus)==null?void 0:i.stage_status)==="processing",r=((o=this.taskStatus)==null?void 0:o.stage_status)==="waiting_confirm",s=((l=this.taskStatus)==null?void 0:l.stage_status)==="error";return n`
      <section class="layout">
        ...
        <article class="panel">
          ...
          <button @click=${()=>{var d,h;return(h=(d=this.shadowRoot)==null?void 0:d.querySelector("label.dropzone input"))==null?void 0:h.click()}}>
            + 继续添加论文
          </button>
          ...
          ${t&&this.taskStatus?n`
            <div class="message-log">
              ...
              ${this.taskStatus.messages.slice(-5).map(d=>n`
                <div class="message-item">
                  <span class="message-time">${new Date(d.timestamp).toLocaleTimeString()}</span>
                  <span class="message-from ${d.from}">${d.from==="system"?"系统":d.from==="agent"?"Agent":d.from}</span>
        ...
        <article class="panel">
          ...
          `:r&&e?n`
            ...
            <div class="topics-section">
              ...
              ${this.topics.map(d=>n`
                <div 
                  class="candidate ${d.id===this.selectedTopicId?"active":""}"
                  @click=${()=>this.selectTopic(d)}
                >
                  <div class="candidate-header">
                    <span class="candidate-title">${d.title}</span>
                    <span class="candidate-score">${d.score}%</span>
                  </div>
                  <div class="candidate-summary">${d.summary}</div>
                  <div class="candidate-detail">
                    <div><strong>理论依据：</strong>${d.rationale}</div>
                    <div><strong>可行性：</strong>${d.feasibility}</div>
                  </div>
                </div>
              `)}
              ...
              <div class="feedback-section">
                ...
                ${this.feedbackHistory.length>0?n`
                  <div class="feedback-history">
                    ${this.feedbackHistory.map((d,h)=>n`
                      <div class="feedback-item">
                        <span class="round">第 ${h+1} 轮反馈：</span>
                        <span class="text">${d.feedback}</span>
                      </div>
                    `)}
                  </div>
                `:""}
                ...
                <div class="feedback-input">
                  <textarea 
                    ...
                    @input=${d=>this.currentFeedback=d.target.value}
                  ></textarea>
          ...
          `:s?n`
            <div class="empty" style="border-color: #fee2e2; color: #991b1b;">
              处理出错：${((p=this.taskStatus)==null?void 0:p.error)||"未知错误"}
            </div>
          `:n`
            ...
            <div class="topic-detail">
              <div class="field">
                ...
                <input
                  ...
                  @input=${d=>this.updateTopicField("title",d.target.value)}
                >
              </div>
              ...
              <div class="field">
                ...
                <textarea
                  ...
                  @input=${d=>this.updateTopicField("researchObjective",d.target.value)}
                ></textarea>
              </div>
              ...
              <div class="field">
                ...
                <textarea
                  ...
                  @input=${d=>this.updateTopicField("expectedContribution",d.target.value)}
                ></textarea>
              </div>
            </div>
